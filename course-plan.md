...
· Cuando tengas el enlace del CodePen/starter, reemplaza el placeholder.
· Al terminar, borra este bloque de instrucciones y exporta a PDF.
· Nombre del PDF: upc-pre-202610-1asi0730-[NRC]-[startup]-course-plan.pdf
════════════════════════════════════════════════════════════════
-->
...
**Repositorio de código fuente**: [https://github.com/[usuario]/webdev-course-[nombre-del-equipo]](https://github.com/[usuario]/webdev-course-[nombre-del-equipo])
<!--
...
-->
### Lección 1: ¿Qué es el desarrollo web? (~8 min)
<!--
...
▸ Reemplaza el enlace de CodePen por el starter que preparaste para la práctica.
...
- **Proyecto final**: [Abrir en CodePen]([ÁNGEL: reemplazar con URL del starter en CodePen]) **¡Personalízalo con tus datos!**
---
...
-->
**Código fuente completo**: [Repositorio de GitHub](https://github.com/[usuario]/webdev-course-[nombre-del-equipo])
